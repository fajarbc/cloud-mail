const zh = {
    ...
    addSmtpConfigDesc: '填写 SMTP 主机、端口、用户名、密码',
    addOsDomain: '添加域名',
    domainDesc: '域名',
    ...
    telegramIdUnlinkConfirm: '确认解绑这个 Telegram ID？',
    ...
    genericSmtpTokenList: 'SMTP 配置列表',
    genericSmtpConfigList: 'SMTP 配置列表',
    domain: '域名',
    optional: '可选',
