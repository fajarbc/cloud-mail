const en = {
    ...
    genericSmtpConfig: 'Generic SMTP',
    ...
    addSmtpConfigDesc: 'Fill SMTP host, port, username, password',
    ...
    tgBotUsernameDesc: 'Bot username, e.g. {\'@\'}cloud_mail_bot',
    telegramId: 'Telegram ID',
    unlink: 'Unlink',
    telegramIdGuide: 'Send /start to the bot to get your Telegram ID:',
    telegramIdPlaceholder: 'Enter Telegram chat ID',
    telegramIdUnlinkConfirm: 'Unlink this Telegram ID?',
    ...
    genericSmtpTokenList: 'SMTP Config List',
    genericSmtpConfigList: 'SMTP Config List',
    domain: 'Domain',
    optional: 'Optional',
